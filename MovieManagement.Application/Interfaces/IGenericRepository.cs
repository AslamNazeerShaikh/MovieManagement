...
public interface IGenericRepository<T> where T : class
{
    ...
    public void Remove(T entity);                                               // Non Async version of Remove
    public void RemoveRange(IEnumerable<T> entities);                           // Non Async version of RemoveRange
    public void Update(T entity);                                               // Non Async version of Update
}